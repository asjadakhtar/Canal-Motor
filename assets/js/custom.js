...
// ===== INFINITE SLIDER CLASS CARS SECTION =====
...
// --- Auto-slide for Slider 3 ---
let autoSlideInterval3;

function startAutoSlide3() {
  autoSlideInterval3 = setInterval(() => {
    // Calls the class method to move to the next slide
    if (window.slider3) {
      window.slider3.moveNext();
    }
...
const sliderContainer3 = document.querySelector('#uf-slider-track-3').parentElement;
...
var myFullpage = new fullpage("#fullpage", {
  ...
  // ADD THESE TOUCH OPTIONS:
  touchSensitivity: 15, // Lower = more sensitive, default is 5
  normalScrollElements: '#news-track, #dashing-track', // Allow touch on these elements
  bigSectionsDestination: 'top', // Helps with touch handling
  
  // Prevent the default warnings
  onScrollOverflow: function(section, slide, position, direction) {
    return true; // Allow native scrolling in overflow sections
  },
