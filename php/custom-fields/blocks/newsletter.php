<section class="section font-primary bg-white py-12 lg:py-24">
  <div class="container mx-auto px-4 flex flex-col lg:flex-row gap-10 lg:gap-16 items-start">
    ...
    <div class="w-full lg:w-1/3 flex flex-col gsap-reveal">
      ...
      <a class="max-w-32 md:max-w-56 text-base text-center font-normal py-3 border-2 hover:text-white hover:bg-black">View All</a>
    </div>
    ...
    <div class="w-full lg:w-2/3 overflow-hidden flash-on-view">
      ...
      <div id="news-track" class="flex transition-transform duration-700 ease-[cubic-bezier(0.25,1,0.5,1)] gap-4 md:gap-6 cursor-grab active:cursor-grabbing">
        ...
        <!-- News Card 1 -->
        <a href="" class="news-card flex-[0_0_66.66%] md:flex-[0_0_40%] shrink-0">
        <div>
          <div class="group overflow-hidden rounded-sm bg-gray-100 aspect-square">
            <img src="http://localhost/canalmotor/wp-content/uploads/2026/01/news2.jpeg" alt="News 1" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700">
          </div>
        ...
        <div>
          <div class="group overflow-hidden rounded-sm bg-gray-100 aspect-square">
            <img src="http://localhost/canalmotor/wp-content/uploads/2026/01/news2.jpeg" alt="News 2" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700">
          </div>
          <div class="mt-4 md:mt-6">
        ...
        <div>
          <div class="group overflow-hidden rounded-sm bg-gray-100 aspect-square">
            <img src="http://localhost/canalmotor/wp-content/uploads/2026/01/news2.jpeg" alt="News 3" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700">
          </div>
          <div class="mt-4 md:mt-6">
        ...
        <div >
          <div class="group overflow-hidden rounded-sm bg-gray-100 aspect-square">
            <img src="http://localhost/canalmotor/wp-content/uploads/2026/01/news2.jpeg" alt="News 4" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700">
          </div>
          <div class="mt-4 md:mt-6">
