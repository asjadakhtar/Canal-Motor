 <div id="fullpage">
      ...
      >
        ...
        <div
          class="relative z-10 text-center px-6 flex flex-col items-center gap-6 sm:gap-10 -translate-y-52 md:-translate-y-20 transition-all duration-700 ease-out"
        >
      ...
      >
        ...
        <div
          class="relative z-10 text-center px-6 max-w-7xl mx-auto flex flex-col items-center gap-8 md:gap-12 -translate-y-16 md:-translate-y-44 transition-transform duration-700"
        >
          <!-- Main Heading -->
          <h1
      ...
      <section
        class="section relative min-h-screen w-full flex flex-col items-center justify-center overflow-hidden text-white"
      >
        <!-- Background Logic -->
        <div class="absolute inset-0 z-0">
          <!-- Mobile Background -->
          <img
            src="https://mintcream-spoonbill-317228.hostingersite.com/wp-content/uploads/2026/01/p4_m.webp"
            class="block sm:hidden w-full h-full object-cover"
            alt="mobile bg"
          />
          ...
          <!-- Desktop Background -->
          <img
            src="https://mintcream-spoonbill-317228.hostingersite.com/wp-content/uploads/2026/01/p4.webp"
            class="hidden sm:block w-full h-full object-cover"
            alt="desktop bg"
          />
        ...
        <div
          class="relative z-10 w-full max-w-8xl mx-auto px-6 py-20 flex flex-col items-center text-center"
        >
          <!-- Top Header Section -->
          <div class="mb-12 md:mb-32">
            <h1 class="gsap-reveal text-3xl md:text-6xl font-medium tracking-wide mb-8">
              JETOUR, Born for Travel
            </h1>
            <p
              class="gsap-reveal max-w-6xl mx-auto text-sm md:text-2xl font-normal leading-relaxed"
            >
              Guided by 'Travel+' strategy, JETOUR makes cars from the
              perspective of users, with thinking of travel industry and
              capabilities of auto industry.
            </p>
          </div>

          <!-- Middle Grid Section (Travel+ Product & Lifestyle) -->
          <div
            class="gsap-reveal w-full grid grid-cols-1 md:grid-cols-2 gap-20 mb-16 md:mb-32"
          >
            <!-- Left Group: Travel+ Product -->
            <div class="flex flex-col items-center">
              <h2 class="text-xl md:text-3xl font-normal mb-8 pb-2 w-fit">
                Travel+ Product
              </h2>
              <div class="grid grid-cols-2 md:grid-cols-4 w-full">
                <div class="border-r border-white/40 mb-6 md:mb-0">
                  <h3 class="text-lg md:text-2xl font-medium mb-2">Off-road</h3>
                  <p class="text-base tracking-tighter">All-terrain</p>
                </div>
                <div class="md:border-r border-white/40 mb-6 md:mb-0">
                  <h3 class="text-lg md:text-2xl font-medium mb-2">Space</h3>
                  <p class="text-base tracking-tighter">Big space</p>
                </div>
                <div class="border-r border-white/40">
                  <h3 class="text-lg md:text-2xl font-medium mb-2">
                    Intelligence
                  </h3>
                  <p class="text-base tracking-tighter">Smart Control</p>
                </div>
                <div class="px">
                  <h3 class="text-lg md:text-2xl font-medium mb-2">Health</h3>
            ...
            <div class="flex flex-col items-center">
              ...
              <div class="grid grid-cols-2 md:grid-cols-4 w-full">
                ...
                <div class="md:border-r border-white/40 px-2 mb-6 md:mb-0">
                  <h3 class="text-lg md:text-2xl font-medium mb-2">+Benefit</h3>
                  <p class="text-base tracking-tighter">Various</p>
                </div>
                <div class="border-r border-white/40 px-2">
                  <h3 class="text-lg md:text-2xl font-medium mb-2">+Station</h3>
                  <p class="text-base tracking-tighter">Multifunctional</p>
                </div>
                <div class="px-2">
                  <h3 class="text-lg md:text-2xl font-medium mb-2">+Refit</h3>
          ...
          <div class="gsap-reveal max-w-7xl">
            <p
              class="text-base md:text-2xl font-normal leading-relaxed tracking-wide"
            >
              We extend our product development philosophy to the entire ecology
              chain in travel scenarios, aiming to be the auto brand with the
              deepest understandings of travel.
            </p>
          </div>
        </div>
      </section>
