<section class="relative h-screen w-full flex flex-col items-center justify-center overflow-hidden">
    ...
    <div class="relative z-10 text-center px-6 flex flex-col items-center gap-6 sm:gap-10 -translate-y-52 md:-translate-y-20 transition-all duration-700 ease-out">
        ...
        <div class="flex flex-col md:flex-row items-center justify-center gap-4 md:gap-10">
            ...
            <!-- SVG Logo -->
            <div class="w-[240px] sm:w-[300px] md:w-[500px] lg:w-[600px] h-auto drop-shadow-2xl">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 211 20" class="w-full h-full fill-white">
...
<section class="bg-white py-16 md:py-24 px-6">
    <div class="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-10 lg:gap-16">
        ...
        <div class="w-full lg:w-2/5 flex flex-col justify-center">
            ...
            <!-- Heading -->
            <h2 class="text-black text-3xl md:text-5xl font-medium mb-6 tracking-tight">
                Product Line
            </h2>
            ...
            <div class="flex flex-col items-center">
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 w-full">
                    ...
                    <div class="border-r border-white/40 ">
                        <h3 class="text-lg md:text-2xl font-medium mb-2">Intelligence</h3>
            ...
            <div class="flex flex-col items-center">
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 w-full">
                    <div class="border-r border-white/40 px-2 mb-6 md:mb-0">
                        <h3 class="text-lg md:text-2xl font-medium mb-2">+Accessory</h3>
